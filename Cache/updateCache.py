...
if not hasTFC ^ isOld:                                                  # If we only need one of the files,
    ...
    if hasTFC:
        os.system('tar -xvzf ' + TName+'/'+TName + '.tar.gz ' + TName + '_tfc.json')
    else:
...
if not hasTFC or isOld:        # If downloads were necessary, make the tarball
    os.system('tar -cvzf ' + TName+'/'+TName + '.tar.gz ' + TName + '_tfc.json ' + TName + '.json')
    os.system('rm ' + TName + '_tfc.json ' + TName + '.json')
