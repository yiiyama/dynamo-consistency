...
echo ""                                                   >> $crabConfFile
echo "additional_input_files    = ../ConsistencyCheck/ConsistencyCheck.py,../ConsistencyCheck/TFCConverter.py,../ConsistencyCheck/compare.py,../ConsistencyCheck/deco.py,tempConfig.cfg" >> $crabConfFile
echo ""                                                   >> $crabConfFile
